...
**Mani's Portfolio** is a unique, sketch-book themed 3D interactive web application showcasing work across Full Stack Development (MERN), Custom Transformer Architectures (PyTorch), and Generative AI (RAG & ChromaDB). It blends hand-drawn aesthetics with real-time 3D web graphics, spatial ambient audio, interactive room exploration, and smooth paper-style transitions.
...
│   ├── data/              # Projects, skills, journey data
...
<p align="center">
  Crafted with ❤️ by <strong>Chappidi Venkata Manindra Babu (Mani)</strong> using React 19 & Three.js
</p>
