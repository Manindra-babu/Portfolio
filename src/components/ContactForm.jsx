...
export default function ContactForm() {
  ...
  return (
    <form
      ...
      aria-label="Send a message to Mani"
    >
      <div style={{ textAlign: 'left', borderBottom: '1px solid var(--border-primary)', paddingBottom: '16px' }}>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
          Tell me about your project, idea, or engineering opportunity.
        </p>
      </div>
      ...
      {status === 'success' && (
        ...
        >
          Thank you! Your message was transmitted successfully. Mani will respond within 24 hours.
        </div>
      )}
      ...
      {status === 'error' && (
        ...
        >
          Something went wrong. Please try again or email directly at manindrachowdhary1715@gmail.com
        </div>
      )}
