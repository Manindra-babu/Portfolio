...
import MusicVoyageRoom from '../rooms/Music/MusicVoyageRoom';
...
const SUBTITLES = {
    ...
    'VINYL LOUNGE': 'Interactive 3D turntable & favorite songs'
};
            ...
            {showRoom && (
                <group>
                    {isGallery ? (
                        ...
                        // === NEW MUSIC VINYL LOUNGE ROOM ===
                        <group position={[0, -0.5, -corridorDepth]}>
                            <Suspense fallback={null}>
                                <MusicVoyageRoom showRoom={showRoom} onReady={onReady} isExiting={isExiting} />
                            </Suspense>
                        </group>
                    ) : (
