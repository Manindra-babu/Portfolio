...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for MANI split effect (4 letters)
    const letters = useMemo(() => [
        { char: 'M', baseX: -0.9, splitDir: -1.8 },
        { char: 'A', baseX: -0.3, splitDir: -0.6 },
        { char: 'N', baseX: 0.3, splitDir: 0.6 },
        { char: 'I', baseX: 0.9, splitDir: 1.8 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: 'Full Stack', baseX: -1.3, splitDir: -1.8 },
        { text: 'AI & ML', baseX: -0.4, splitDir: -0.6 },
        { text: 'Engineer', baseX: 0.4, splitDir: 0.6 },
