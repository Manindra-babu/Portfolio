...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'A full stack RAG application that lets users upload private documents (PDFs, DOCX, TXT) and chat with them accurately using Groq LLM & ChromaDB.',
    ...
    },
    {
        ...
        description: 'Built a GPT from scratch using PyTorch with multi-head self-attention, causal masking, custom tokenization loops, and real-time web inference.',
    ...
    },
    {
        ...
        description: 'Built and deployed responsive full-stack applications with MERN stack and Tailwind CSS with Firebase auth and secured RESTful APIs at Technical Hub.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        ...
        description: 'Google-Hosted Hackathon Top 10 Qualifier: High-availability emergency response network demonstrating multi-level incident screening and rapid routing.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        ...
        description: 'A high-speed semantic document assistant offering instant embedding search, conversational memory, and context-aware LLM synthesis with ChromaDB.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    }
];
