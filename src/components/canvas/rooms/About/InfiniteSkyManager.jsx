    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                fontStyle="italic"
            >
                and intelligent LLM architectures with precision"
            </Text>
        </group>
    );
};
...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Full Stack MERN Engineering (MongoDB, Express, React, Node)', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Deep Learning & Custom GPT (PyTorch / Transformers)', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'RAG Systems & Vector Search (Groq LLM / ChromaDB)', date: 'Active', image: '/textures/about/button.webp', url: '#' },
            { label: 'Cloud Persistence & Authentication (Firebase / SQL)', date: 'Active', image: '/textures/about/button.webp', url: '#' },
        ],
        platformConfig: {
            label: 'EXPERTISE',
            color: '#00D9FF',
    ...
    sotd: {
        ...
        items: [
            { label: 'Aditya University — B.Tech AI & ML (CGPA 8.44)', date: '2024 - 2028', image: '/textures/about/button.webp', url: '#' },
            { label: 'Google-Hosted Hackathon Top 10 Qualifier', date: '2025', image: '/textures/about/button.webp', url: '#' },
            { label: 'Technical Hub Full Stack Developer Intern', date: '2026', image: '/textures/about/button.webp', url: '#' },
            { label: 'Emergency Response Network System Lead', date: 'Active', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'ACADEMICS',
            color: '#00D9FF',
    ...
    sotm: {
        ...
        items: [
            { label: 'Red Hat — OpenShift & System Administration I & II', date: 'Certified', image: '/textures/about/button.webp', url: '#' },
            { label: 'CISCO — C Essentials 1 Certification', date: 'Certified', image: '/textures/about/button.webp', url: '#' },
            { label: 'IBM — Python for Data Science Certification', date: 'Certified', image: '/textures/about/button.webp', url: '#' },
            { label: 'Microsoft — Excel Associate & Power Platform Fundamentals', date: 'Certified', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'CERTIFIED',
            color: '#00D9FF',
    ...
    other: {
        ...
        items: [
            { label: 'Knowledge Base Retrieval System (RAG / ChromaDB)', date: '2026', image: '/textures/about/button.webp', url: '#' },
            { label: 'Custom GPT from Scratch (PyTorch)', date: '2026', image: '/textures/about/button.webp', url: '#' },
            { label: 'Secured RESTful Microservices & Auth Systems', date: '2026', image: '/textures/about/button.webp', url: '#' }
        ],
        platformConfig: {
            label: 'PROJECTS',
            color: '#00D9FF',
    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                font="/fonts/CabinSketch-Regular.ttf"
            >
                Aditya University & Real-World Engineering
            </Text>
