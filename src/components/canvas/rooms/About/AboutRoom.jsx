...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'MANI', subtitle: '< full stack developer • ai & ml • mern stack • llm architectures />' },
    { id: 'focus', position: [0, 0, -55], type: 'awards', title: 'EXPERTISE', subtitle: 'MERN Stack • Large Language Models • PyTorch • Deep Learning' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Aditya University • Technical Hub • Hackathon Top 10 Qualifier' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'React • Node.js • Express • MongoDB • Python • PyTorch • ChromaDB' },
];
