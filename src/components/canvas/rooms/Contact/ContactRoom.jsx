    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="GITHUB"
                onClick={() => window.open('https://github.com/Manindra-babu', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/manindra-chowdhary-198747333/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* LEETCODE */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="LEETCODE"
                onClick={() => window.open('https://leetcode.com/u/Mani_359/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* EMAIL */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.location.href = 'mailto:manindrachowdhary1715@gmail.com'}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
