...
export default function Contact() {
  ...
  const handleCopyEmail = () => {
    navigator.clipboard.writeText('manindrachowdhary1715@gmail.com');
    setCopied(true);
    setTimeout(() => setCopied(false), 2000);
  };

  const handleCopyPhone = () => {
    navigator.clipboard.writeText('+917989882191');
    setPhoneCopied(true);
        ...
        >
          ...
          >
            ...
            >
              ...
              Open for full stack & AI/ML opportunities
            </div>
            ...
            >
              ...
              <span className="text-gradient-purple">Intelligent & Scalable.</span>
            </h2>
            <p
              style={{
                fontSize: '1.1rem',
            ...
            >
              Whether it's an AI/ML retrieval pipeline, full stack MERN web application, or custom transformer architecture, I'm always excited to collaborate on cutting-edge engineering.
            </p>
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                <a
                  href="mailto:manindrachowdhary1715@gmail.com"
                  style={{
                ...
                >
                  manindrachowdhary1715@gmail.com
                </a>
                <button
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '20px' }}>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <a
                    href="tel:+917989882191"
                    style={{ fontSize: '0.95rem', color: 'var(--text-primary)', fontWeight: 600, textDecoration: 'none' }}
                  ...
                  <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                    <a
                      href="https://wa.me/917989882191?text=Hi%20Mani,%20I%20saw%20your%20portfolio!"
                      target="_blank"
