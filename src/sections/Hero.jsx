      ...
      <div className="container" style={{ position: 'relative', zIndex: 10, width: '100%' }}>
        <div className="hero-content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left', maxWidth: '720px' }}>
            ...
            >
              Engineering Intelligent AI Systems & Scalable Web Platforms.
            </h1>
            ...
            >
              Detail-oriented B.Tech (AI & ML) engineer experienced in MERN stack development, custom PyTorch deep learning architectures, Groq LLM retrieval systems (RAG), and high-reliability full stack software.
            </p>
