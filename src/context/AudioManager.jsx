...
export const AudioProvider = ({ children }) => {
    ...
    const play = useCallback((soundName, { loop = false, volume = 1.0 } = {}) => {
        const soundPaths = {
            ...
            'papersound': '/sounds/papersound.mp3',
            'paper': '/sounds/papersound.mp3',
            'pencil': '/sounds/papersound.mp3',
            'tear': '/sounds/papersound.mp3',
            'baloonpoop': '/sounds/baloonpoop.mp3',
            'szummorza': '/sounds/szummorza.mp3',
            'szummonitorow': '/sounds/szummonitorow.mp3'
        };
